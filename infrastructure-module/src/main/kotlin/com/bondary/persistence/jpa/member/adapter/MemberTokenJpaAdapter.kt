...
import com.bondary.security.JwtTokenType.ACCESS_TOKEN
import com.bondary.security.JwtTokenType.REFRESH_TOKEN
...
class MemberTokenJpaAdapter(
    ...
    override fun generateRegisterToken(
        ...
        val jwtClaims = RegisterJwtClaimsForMember(
            name = name,
            email = email,
    ...
    override fun resolveRegisterToken(token: String): TokenType.RegisterToken {
        val jwtPayload: JwtPayload<RegisterJwtClaimsForMember> =
    ...
    override fun resolveAccessToken(token: String): TokenType.AccessToken {
        val jwtPayload: JwtPayload<JwtClaimsForMember> =
